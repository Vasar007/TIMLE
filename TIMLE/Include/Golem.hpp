...
/**
 * \brief Classs for the old and strong earth golem.
 */
class Golem final : public Enemy 
{
	public:
		 ...
		 */
				Golem(Type::ID Id, const TextureHolder& textures, const FontHolder& fonts, 
					  Level& lvl, float X, float Y, int width, int height, std::string Type = "0");
