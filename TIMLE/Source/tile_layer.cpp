...
constexpr std::size_t tile_layer::get_index_in_array(const unsigned int x, const unsigned int y,
                                                     const unsigned int offset) const noexcept
{
                           ...
                           sf::RenderStates states) const
{
    ...
    if (_drawing_vertices.empty()) return;
