...
, _playerInfo(*context.mPlayerInfo)
{
    ...
    switch(_playerInfo.mDialogNumber)
    {
        ...
        case 8:
            ...
            else if (_playerInfo.mChosenSolution.at(0) == 2)
            {
    ...
    {
        if (_playerInfo.mDialogNumber == 7 && _playerInfo.mChosenSolution.at(0) == 0)
        {
            _playerInfo.mChoosingNumber = 1;
            requestStackPush(States::ID::Choosing);
            _choosing = true;
        }
        else if (_playerInfo.mDialogNumber == 7 && _playerInfo.mChosenSolution.at(0) != 0 &&
                 _textNumber == 0)
        {
            if (_playerInfo.mChosenSolution.at(0) == 1)
            {
        ...
        else if (_playerInfo.mDialogNumber == 8 && _playerInfo.mChosenSolution.at(1) == 0 &&
                 _textNumber == 1)
        {
            ...
            _choosing = true;
                 ...
                 _textNumber == 1)
        {
            if (_playerInfo.mChosenSolution.at(1) == 1)
            {
            ...
            else if (_playerInfo.mChosenSolution.at(1) == 2)
            {
            ...
            else if (_playerInfo.mChosenSolution.at(1) == 3)
            {
